...
namespace ZenLib.TransitionSystem
{
    ...
    public class Or<T> : Spec<T>
    {
        ...
        {
            return Spec.Or(this.Spec1.Nnf(), this.Spec2.Nnf());
        }
        ...
        {
            return Zen.Or(this.Spec1.EncodeLoopFree(states, i, k), this.Spec2.EncodeLoopFree(states, i, k));
        }
        ...
        {
            return Zen.Or(this.Spec1.EncodeLoop(states, l, i, k), this.Spec2.EncodeLoop(states, l, i, k));
        }
    }
}
