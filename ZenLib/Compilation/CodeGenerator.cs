...
namespace ZenLib.Compilation
{
    ...
    internal static class CodeGenerator
    {
            ...
            ImmutableDictionary<long, Expression> arguments)
        {
            ...
            var expr = CompileToBlock(expression, env, ImmutableDictionary<object, Expression>.Empty, ImmutableDictionary<object, Expression>.Empty);
        ...
        {
            var converter = new ExpressionConverterVisitor(subexpressionCache, lambdas);
