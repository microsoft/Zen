...
namespace ZenLib
{
    ...
    public abstract class Zen<T>
    {
        ...
        public static Zen<bool> operator !=(Zen<T> expr1, Zen<T> expr2)
        {
            return Basic.Not(Basic.Eq(expr1, expr2));
        }
        ...
        public static Zen<T> operator +(Zen<T> expr1, Zen<T> expr2)
        {
            ...
            {
                return Basic.Concat(expr1 as Zen<string>, expr2 as Zen<string>) as Zen<T>;
            }

            return Basic.Plus(expr1, expr2);
        }
        ...
        public static Zen<T> operator -(Zen<T> expr1, Zen<T> expr2)
        {
            return Basic.Minus(expr1, expr2);
        }
        ...
        public static Zen<T> operator *(Zen<T> expr1, Zen<T> expr2)
        {
            return Basic.Multiply(expr1, expr2);
        }
        ...
        public static Zen<T> operator &(Zen<T> expr1, Zen<T> expr2)
        {
            return Basic.BitwiseAnd(expr1, expr2);
        }
        ...
        public static Zen<T> operator |(Zen<T> expr1, Zen<T> expr2)
        {
            return Basic.BitwiseOr(expr1, expr2);
        }
        ...
        public static Zen<T> operator ^(Zen<T> expr1, Zen<T> expr2)
        {
            return Basic.BitwiseXor(expr1, expr2);
        }
