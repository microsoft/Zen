...
namespace ZenLib.ModelChecking
{
    ...
    /// </summary>
    internal class SymbolicBitvec<TModel, TVar, TBool, TBitvec, TInt, TSeq, TArray> : SymbolicValue<TModel, TVar, TBool, TBitvec, TInt, TSeq, TArray>
    {
        public SymbolicBitvec(ISolver<TModel, TVar, TBool, TBitvec, TInt, TSeq, TArray> solver, TBitvec value) : base(solver)
        {
            this.Value = value;
        }
        ...
        {
            var o = (SymbolicBitvec<TModel, TVar, TBool, TBitvec, TInt, TSeq, TArray>)other;
            var value = this.Solver.Ite(guard, this.Value, o.Value);
            return new SymbolicBitvec<TModel, TVar, TBool, TBitvec, TInt, TSeq, TArray>(this.Solver, value);
        }
        ...
        internal override TReturn Accept<TParam, TReturn>(
            ...
            TParam parameter)
        {
            return visitor.VisitSymbolicBitvec(this, parameter);
        }
