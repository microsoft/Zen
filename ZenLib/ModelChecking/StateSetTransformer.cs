...
namespace ZenLib.ModelChecking
{
    ...
    public class StateSetTransformer<T1, T2>
    {
        ...
        public StateSet<T1> InputSet(Func<Zen<T1>, Zen<T2>, Zen<bool>> invariant)
        {
            ...
            var symbolicEvaluator = new SymbolicEvaluationVisitor<Assignment<BDDNode>, Variable<BDDNode>, DD, BitVector<BDDNode>, Unit, Unit, Unit, BitVector<BDDNode>>(this.solver);
            ...
            var symbolicResult =
                (SymbolicBool<Assignment<BDDNode>, Variable<BDDNode>, DD, BitVector<BDDNode>, Unit, Unit, Unit, BitVector<BDDNode>>)symbolicEvaluator.Evaluate(expr, env);
