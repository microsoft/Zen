...
namespace ZenLib
{
    ...
    internal sealed class ZenMapCombineExpr<TKey> : Zen<Map<TKey, SetUnit>>
    {
        ...
        /// </summary>
        public SetCombineType CombinationType { get; }
        ...
        private static Zen<Map<TKey, SetUnit>> Simplify(
            (Zen<Map<TKey, SetUnit>> map1, Zen<Map<TKey, SetUnit>> map2, SetCombineType combinationType) args)
        {
            // a union a = a
            // a inter a = a
            // a minus a = {}
            ...
            {
                return args.combinationType == SetCombineType.Difference ? Zen.EmptyMap<TKey, SetUnit>() : args.map1;
            }
            ...
            {
                return args.combinationType == SetCombineType.Union ? args.map2 : args.map1;
            }
            ...
            {
                return args.combinationType == SetCombineType.Intersect ? args.map2 : args.map1;
            }
            ...
            if (args.map1 is ZenMapCombineExpr<TKey> e1 &&
                ...
                args.combinationType != SetCombineType.Difference &&
            ...
            if (args.map1 is ZenMapCombineExpr<TKey> e3 && args.combinationType == SetCombineType.Difference)
            {
                if (e3.CombinationType == SetCombineType.Difference && e3.MapExpr1.Equals(args.map2))
                {
                    return Zen.EmptyMap<TKey, SetUnit>();
                }

                if (e3.CombinationType == SetCombineType.Difference && e3.MapExpr2.Equals(args.map2))
                {
                    return args.map1;
                }
            }
        ...
        public override string ToString()
        {
            ...
            {
                case SetCombineType.Union:
                    return $"Union({this.MapExpr1}, {this.MapExpr2})";
                case SetCombineType.Intersect:
                    return $"Intersect({this.MapExpr1}, {this.MapExpr2})";
                case SetCombineType.Difference:
