// <copyright file="ZenBitwiseOrExpr.cs" company="Microsoft">
...
namespace ZenLib
{
    ...
    /// <summary>
    /// Class representing a Bitwise Or expression.
    /// </summary>
    internal sealed class ZenBitwiseOrExpr<T> : Zen<T>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZenBitwiseOrExpr{T}"/> class.
        /// </summary>
        /// <param name="expr1">First Zen expression.</param>
        /// <param name="expr2">Second Zen expression.</param>
        private ZenBitwiseOrExpr(Zen<T> expr1, Zen<T> expr2)
        {
            this.Expr1 = expr1;
            this.Expr2 = expr2;
        }
