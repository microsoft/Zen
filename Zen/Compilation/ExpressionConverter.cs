...
namespace Microsoft.Research.Zen.Compilation
{
    ...
    internal class ExpressionConverter : IZenExprVisitor<ExpressionConverterEnvironment, Expression>
    {
        ...
        /// <param name="parameter">The parameter.</param>
        /// <returns>The compilable expression.</returns>
        public Expression VisitZenCreateObjectExpr<TObject, T1>(ZenCreateObjectExpr<TObject, T1> expression, ExpressionConverterEnvironment parameter)
        {
            return LookupOrCompute(expression, () =>
            {
                var parameters = new Expression[] { expression.FieldValue1.Accept(this, parameter) };
                var fieldNames = new string[] { expression.FieldName1 };

                return CreateObject<TObject>(parameters, fieldNames);
            });
        }
        ...
        /// <param name="parameter">The parameter.</param>
        /// <returns>The compilable expression.</returns>
        public Expression VisitZenCreateObjectExpr<TObject, T1, T2>(ZenCreateObjectExpr<TObject, T1, T2> expression, ExpressionConverterEnvironment parameter)
        {
            return LookupOrCompute(expression, () =>
            {
        ...
        /// <param name="parameter">The parameter.</param>
        /// <returns>The compilable expression.</returns>
        public Expression VisitZenCreateObjectExpr<TObject, T1, T2, T3>(ZenCreateObjectExpr<TObject, T1, T2, T3> expression, ExpressionConverterEnvironment parameter)
        {
            return LookupOrCompute(expression, () =>
            {
                var parameters = new Expression[] {
        ...
        /// <param name="parameter">The parameter.</param>
        /// <returns>The compilable expression.</returns>
        public Expression VisitZenCreateObjectExpr<TObject, T1, T2, T3, T4>(ZenCreateObjectExpr<TObject, T1, T2, T3, T4> expression, ExpressionConverterEnvironment parameter)
        {
            return LookupOrCompute(expression, () =>
            {
                var parameters = new Expression[] {
        ...
        /// <param name="parameter">The parameter.</param>
        /// <returns>The compilable expression.</returns>
        public Expression VisitZenCreateObjectExpr<TObject, T1, T2, T3, T4, T5>(ZenCreateObjectExpr<TObject, T1, T2, T3, T4, T5> expression, ExpressionConverterEnvironment parameter)
        {
            return LookupOrCompute(expression, () =>
            {
                var parameters = new Expression[] {
        ...
        /// <param name="parameter">The parameter.</param>
        /// <returns>The compilable expression.</returns>
        public Expression VisitZenCreateObjectExpr<TObject, T1, T2, T3, T4, T5, T6>(ZenCreateObjectExpr<TObject, T1, T2, T3, T4, T5, T6> expression, ExpressionConverterEnvironment parameter)
        {
            return LookupOrCompute(expression, () =>
            {
                var parameters = new Expression[] {
        ...
        /// <param name="parameter">The parameter.</param>
        /// <returns>The compilable expression.</returns>
        public Expression VisitZenCreateObjectExpr<TObject, T1, T2, T3, T4, T5, T6, T7>(ZenCreateObjectExpr<TObject, T1, T2, T3, T4, T5, T6, T7> expression, ExpressionConverterEnvironment parameter)
        {
            return LookupOrCompute(expression, () =>
            {
                var parameters = new Expression[] {
        ...
        /// <param name="parameter">The parameter.</param>
        /// <returns>The compilable expression.</returns>
        public Expression VisitZenCreateObjectExpr<TObject, T1, T2, T3, T4, T5, T6, T7, T8>(ZenCreateObjectExpr<TObject, T1, T2, T3, T4, T5, T6, T7, T8> expression, ExpressionConverterEnvironment parameter)
        {
            return LookupOrCompute(expression, () =>
            {
                var parameters = new Expression[] {
